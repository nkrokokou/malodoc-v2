...
export default function AuthLayout({
    ...
    return (
        <div className="flex h-screen w-full bg-background relative">
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-muted/10 items-center justify-center">
                ...
                <div className="relative z-10 p-12 text-center animate-float">
                    <Link href="/" className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-3xl bg-card/50 border border-border backdrop-blur-xl shadow-2xl hover:scale-105 transition-transform cursor-pointer">
                        <svg
                    ...
                    <h1 className="text-4xl font-bold tracking-tighter text-foreground mb-4">{t("app.name")}</h1>
